...
https://webservice-api-lbgh.onrender.com
...
## Important Notes
- **ALLOWED_ORIGINS**: Set this to your Render app URL (e.g., `https://webservice-api-8oy7.onrender.com`)
- The `public/uploads/` directory is automatically created on server startup
- Security headers (CSP, X-Frame-Options, etc.) are configured automatically
